<?php
   ...
   $pid=$_GET['p'] ?? null;
   if (!$pid) header('Location: newcollection_books.php');
   $sel="SELECT * FROM adm_newbook WHERE id='$pid'";
   $Q=mysqli_query($con,$sel);
   $data=mysqli_fetch_assoc($Q);
   if (!$data) header('Location: newcollection_books.php');
 ?>
 <div class="container" id="product_container">
   ...
   <div class="carousel-inner">
     <div class="carousel-item active">
       <img class="d-block w-100" height="400" src="admin/uploads/<?= $data['book_img']; ?>" alt="First slide">
     </div>
     <div class="carousel-item">
       <img class="d-block w-100" height="400" src="admin/uploads/<?= $data['book_img']; ?>" alt="Second slide">
     </div>
   ...
   <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
     ...
     <div class="col-md-7">
        ...
        <p><b>Edition:</b> <?= $data['book_edition']; ?></p>
        <p >Price: <?= $data['book_price']; ?></p>
