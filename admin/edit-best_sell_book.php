<?php
    ...
    if(!empty($_POST)){
        ...
        if(!empty($title)){
            $update="UPDATE adm_newbook SET book_title='$title',book_edition='$edition',book_price='$price',book_stock='$stock',short_desc='$short_desc',description='$description' WHERE id='$id'";
    	...
    	<div class="panel panel-primary">
            <div class="panel-heading">
                <div class="col-md-9 heading_title">
                 ...
                 <div class="col-md-3 text-right">
                 	<a href="all-best_sell_book.php" class="btn btn-sm btn btn-primary"><i class="fa fa-th"></i> All Best Sell Book</a>
                </div>
          ...
          <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="short_desc" value="<?= $info['short_desc'];?>">
                </div>
              </div>
              <div class="form-group">
