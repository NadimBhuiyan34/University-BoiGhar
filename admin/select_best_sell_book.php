	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			...
			<div class="col-md-3 text-right">
				...
				<a href="all-best_sell_book.php" class="btn btn-sm btn btn-primary"><i class="fa fa-plus-circle"></i> All Best
					Sell book</a>
			</div>
				...
				?>
					<tr>
						...
						<td>
							...
							<a href="move_to_best_sellbook.php?ed=<?= $data['id']; ?>"><i
