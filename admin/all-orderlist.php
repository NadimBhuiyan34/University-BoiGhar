<?php
	...
	needLogged();
	if ($_SESSION['role'] != '1') {
		die('Access Denied! You have no permission to access this page.');
	}
  $title = 'Order List';
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			...
			<div class="col-md-3 text-right">
				...
				<a href="all-pending-orderlist.php" class="btn btn-sm btn btn-primary"><i class="fa fa-plus-circle"></i> Pending
				</a>
			</div>
		...
		<div class="panel-body">
			<table class="table table-responsive table-striped table-hover table_cus">
				...
				<tbody>
					<?php
					$sel = 'SELECT * FROM adm_approve_orderlist ORDER BY id DESC';
