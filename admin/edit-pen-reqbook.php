<?php
    ...
    $id=$_GET['ed'];
    $sel="SELECT * FROM adm_pen_reqbook WHERE id=$id";
    ...
    if(!empty($_POST)){
        ...
        if(!empty($title)){
            $update="UPDATE adm_pen_reqbook SET req_title='$title',req_author='$author',req_edition='$edition',req_phone='$phone',req_address='$address' WHERE id='$id'";
            if(mysqli_query($con,$update)){
                header('Location: view-pen-reqbook.php?v='.$id);
            }else{
              echo "Update failed!";
            }
        }else{
            ...
            <div class="panel-heading">
                <div class="col-md-9 heading_title">
                 ...
                 <div class="col-md-3 text-right">
                 	<a href="all-pending-reqbook.php" class="btn btn-sm btn btn-primary"><i class="fa fa-th"></i> Pending Order</a>
                </div>
