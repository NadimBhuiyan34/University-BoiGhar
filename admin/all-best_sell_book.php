	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			...
			<div class="col-md-3 text-right">
				...
				<a href="select_best_sell_book.php" class="btn btn-sm btn btn-primary"><i class="fa fa-plus-circle"></i> Select
					Best Sell book</a>
			</div>
			...
			if ($data['status'] == '7') {
				?>
					<tr>
						...
						<td>
							<a href="view-best_sell_book.php?v=<?= $data['id']; ?>"><i class="fa fa-eye fa-lg"></i></a>
							<a href="edit-best_sell_book.php?ed=<?= $data['id']; ?>"><i class="fa fa-pencil-square fa-lg"></i></a>
							<a href="delete-best_sell_book.php?del=<?= $data['id']; ?>"><i class="fa fa-trash fa-lg"></i></a>
