    ...
    <div class="col-md-12">
    	...
    	<div class="panel panel-primary">
            <div class="panel-heading">
                <div class="col-md-9 heading_title">
                 ...
                 <div class="col-md-3 text-right">
                 	<a href="all-bestsellbook.php" class="btn btn-sm btn btn-primary"><i class="fa fa-th"></i> All Best Sell Books</a>
                </div>
          ...
          <div class="panel-body">
              <?php
                  if(!empty($_POST)){
                      ...
                      if(!empty($book_title)){
                          ...
                          $insert="INSERT INTO adm_bestsellbook(book_title,book_author,book_edition,book_price,book_stock,description,book_flag,book_img)
                          VALUES('$book_title','$book_author','$book_edition','$book_price','$book_stock','$description','$book_flag','$imageName')";
                          if(mysqli_query($con,$insert)){
                              move_uploaded_file($image['tmp_name'],'uploads/'.$imageName);
                              echo "Best Sell book Successfully Published";
                          }else{
                              echo "Failed publish";
                          }
              ...
              <div class="form-group">
                <label for="" class="col-sm-3 control-label">Book Flag</label>
                <div class="col-sm-8">
