<?php
    ...
    get_sidebar();
    $id=$_GET['v'];
    checkAndGoto($id, 'all-donate_book_request');
    $sel="SELECT * FROM adm_donate_book_request WHERE id='$id'";
    $Q=mysqli_query($con,$sel);
    $in=mysqli_fetch_assoc($Q);
    checkAndGoto($in, 'all-donate_book_request');
?>
<div class="col-md-12">
	<div class="panel panel-primary">
		<div class="panel-heading">
			...
			<div class="col-md-3 text-right">
				<a href="all-donate_book_request.php" class="btn btn-sm btn btn-primary"><i class="fa fa-th"></i> All Book
					Request</a>
			</div>
			...
			<div class="col-md-9">
				<table class="table table-hover table-striped table-responsive view_table_cus">
					...
					<tr>
						...
						<td>
							<p><a
									href="mailto:<?= $in['email'];?>?subject=UBoighar%20Support%20Team&body=Thank%20You,%20For%20Contact%20With%20Us%3A%0D%0A%0D%0ACheers%2C%0D%0AHappy%20Customer">Send
									<i class="fa fa-envelope fa-lg"></i></a></p>
						</td>
					</tr>
				</table>
			</div>
