...
$discount =0.00;
 ...
 if(isset($_POST['submit'])){
   ...
   $insert="INSERT INTO adm_billing_info(fullname,email,mobile,address,city,zipcode,paymentMethod,paymentNumber,transactionId,deliveryArea)
         VALUES ('$fullname','$email','$mobile','$address','$city','$zipcode','$paymentMethod','$paymentNumber','$transactionId','$deliveryArea')";
    ...
    <div class="col-md-12">
      ...
      <div class="card-body">
            ...
            <table class="table table-bordered table-info table-striped">
               ...
               <tr>
                 <td colspan="3" align="right">Total</td>
                 <td align="right">$<?php $totalprice= number_format(($total-$mainprice), 2); echo $totalprice; ?></td>
               </tr>
               <?php
               }
               ?>
